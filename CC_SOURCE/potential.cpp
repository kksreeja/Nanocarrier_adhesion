...
void _potential :: init(){
  ...
  //@
  this->verptr=&module_datastruct_mp_ver;                                                  // pointer to vertex type
  this->antptr=&module_datastruct_mp_antig;                                                // pointer to antigen type
  this->triptr=&module_datastruct_mp_tri;                                                  // pointer to triangle type
}
